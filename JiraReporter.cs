...
namespace work_charts
{
    ...
    class JiraReporter
    {
        ...
        public void GenerateTicketListSummary(JiraSearchResponse searchResponse, DateTime startDate, DateTime endDate, string xlsxOutputPath = null)
        {
            ...
            else
            {
                ...
                using (SpreadsheetDocument spreadsheetDocument = SpreadsheetDocument.Create(xlsxOutputPath, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    double maintTicketPercent = maintTicketCount / totalTickets;
                    ...
                    InsertCellInWorksheet("F", 6, maintTicketPercent.ToString(), worksheetPart, FormatOptions.Percent);
        ...
        private static Cell InsertCellInWorksheet(string columnName, uint rowIndex, string cellValue, WorksheetPart worksheetPart, FormatOptions format)
        {
